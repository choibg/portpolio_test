...
// http://javascript-source.com
//***********************************************
jQuery("#wowslider-container22").wowSlider({effect:"fade",prev:"",next:"",duration:20*100,delay:30*100,width:1967,height:1090,autoPlay:true,playPause:false,stopOnHover:false,loop:false,bullets:0,caption:false,captionEffect:"slide",controls:true,onBeforeStep:0,images:0});